...
<div class="container mt-5">
    <p class="h2">Data Barang Keluar</p>
                        ...
                        <div class="container mt-3">
                            <table class="table table-bordered border-primary" id="tabel-data">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "SELECT is_barang_keluar.kode_transaksi, is_barang_keluar.tgl_input, is_kasur.nama_kasur, is_barang_keluar.jumlah_keluar, is_barang_keluar.satuan FROM is_barang_keluar 
