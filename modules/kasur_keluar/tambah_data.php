                ...
                <div class="card text-center mt-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="p-2 "><a href="kasur_keluar.php" class="fa fa-undo" style="text-decoration:none"> Kembali</a></button></div>
                        </div>
                        <hr>
                        ...
                        <form action="tambah_data_aksi.php" method="post">
                            ...
                            $query = mysqli_query($koneksi, "SELECT max(kode_transaksi) as kodeTerbesar FROM is_barang_keluar");
