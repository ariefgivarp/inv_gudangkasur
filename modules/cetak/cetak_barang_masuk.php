                        ...
                        <div class="contact-form">
                            <div class="container">
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    inner join is_supplier on is_supplier.kode_supplier = is_barang_masuk.kode_supplier";
                                    ...
                                    inner join is_kasur on is_kasur.kode_kasur = is_barang_masuk.kode_kasur 
                                    inner join is_supplier on is_supplier.kode_supplier = is_barang_masuk.kode_supplier WHERE (is_barang_masuk.tgl_input BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
