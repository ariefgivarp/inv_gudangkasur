...
<body>
	...
	if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        inner join is_kasur on is_kasur.kode_kasur = is_barang_keluar.kode_kasur ORDER BY tgl_input DESC";
		$url_cetak = "cetak_keluar.php";
		$label = "* Semua Data Transaksi";
	} else { // Jika terisi
		// Buat query untuk menampilkan data transaksi sesuai periode tanggal
		$query = "SELECT is_barang_keluar.kode_transaksi, is_barang_keluar.tgl_input, is_kasur.nama_kasur, is_barang_keluar.jumlah_keluar, is_barang_keluar.satuan FROM is_barang_keluar 
        inner join is_kasur on is_kasur.kode_kasur = is_barang_keluar.kode_kasur WHERE (is_barang_masuk.tgl_input BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "') order by tgl_input desc";
