                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered border-primary" id="tabel-data">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "SELECT * FROM is_supplier ORDER BY nama_supplier DESC");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle="tooltip" data-placement="top" title="edit" href="supplier_edit.php?id=<?php echo $d['id']; ?>"><span class="fa fa-pencil-square"></span></a>
                                                <a data-toggle="tooltip" data-placement="top" title="Hapus" href="supplier_hapus.php?id=<?php echo $d['id']; ?>"><span class="fa fa-trash"></span></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
